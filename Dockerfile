# Vendored from tModLoader upstream, branch 1.4.5:
#   patches/tModLoader/Terraria/release_extras/DedicatedServerUtils/Dockerfile
# Refresh with the curl command in README.md and rebuild. Vendored rather than
# fetched at build time so a build is reproducible and upstream changes are
# visible as a diff instead of arriving silently.
